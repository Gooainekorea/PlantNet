...
첫번쨰 회사에서 이슈사항 기재하라고함. 다행히 최근이고 내가 프로젝트하면서 여기저기 텍스트로 남긴 메모가 있었지만 이떄까지도 뭐가 문제지 모르고 시간없다고 모델학습부분만 엉성하게 정리해서 올림.

두번쨰 회사 가서는 기기통신질의인줄 알고 통신쪽은 팀장이했다함. 그리고 왜 서버통신관련 질문 안하는지 의아해했음.

그때서야 감잡힘. 이슈사항을 넣으라는게 이렇게 하면 좋았겠지만 난 못했다는걸 말하는게 아니라 하는 과정에서 힘들었는데 왜 힘들었고 그걸 어떻게 해결했는지를 썼어야했음.
...
앞으로 모든걸 깃에다 남길꺼임
옵시디언 마크다운 언어에 최적화 되있긴한데 접근성이 좋아야 어디서든 메모남기기 편함.
