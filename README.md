...
첫번쨰 회사에서 이슈사항 기재하라고함. 다행히 최근이고 내가 프로젝트하면서 여기저기 텍스트로 남긴 메모가 있었지만 이떄까지도 뭐가 문제지 모르고 있었음

두번쨰 회사 갔다와서 감잡힘 내가 하는 과정에서 힘들었던걸 왜 힘들었고 그걸 어떻게 해결했는지를 기재했어야했음.

지금 팀프로젝트도 다시 정리해야함

학기초에 C로 미로찾기 한다고 하면서 고생했는데 과정 안남긴게 후회됨. 

이떄 AI써서 한다고 했다가 당시 내 능력 넘어서서 리눅스 깔린 노트북에서 씨메이커로 값이 어디서 어디로 넘어가는지 한줄한줄 찍어보고 왜 제대로 안넘어가는지 찾아보고 쓰레드 써야하는거알고 멋모르고썼다가  
---
